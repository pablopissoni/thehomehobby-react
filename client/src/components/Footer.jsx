...
export const Footer = () => {
  return (
    <footer className="dark:dark:bg-gray-800 dark:dark:text-gray-50 ">
      <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row dark:dark:divide-gray-400">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:dark:bg-violet-400 dark:dark:text-gray-900"
            >
              <svg
