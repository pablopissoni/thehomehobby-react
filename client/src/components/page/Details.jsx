          ...
          <div className="swiper swiper-top group relative flex items-center rounded-lg swiper-fade swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden">
            ...
            >
              <div
                ...
                style="width: 438px; opacity: 1; transform: translate3d(0px, 0px, 0px);"
                role="group"
                aria-label="1 / 3"
              >
                <div
              ...
              <div
                ...
                style="width: 438px; opacity: 0; transform: translate3d(-438px, 0px, 0px);"
                role="group"
                aria-label="2 / 3"
              >
              ...
              <div
                ...
                role="group"
                aria-label="3 / 3"
                style="width: 438px; opacity: 0; transform: translate3d(-876px, 0px, 0px);"
              >
                <div className="swiper-zoom-container">
          ...
          <div className="swiper swiper-thumbs swiper-initialized swiper-horizontal swiper-free-mode swiper-watch-progress swiper-backface-hidden">
            ...
            >
              <div
                ...
                style="width: 99.5px; margin-right: 10px;"
                role="group"
                aria-label="1 / 3"
              >
            ...
            <form>
              ...
              <div className="flex flex-wrap justify-start gap-5">
                ...
                <div className="flex gap-2">
                  ...
                  <a className="tippy tippy-wishlist btn-wishlist transition-all-300 flex min-h-[40px] min-w-[40px] cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary-color p-2 hover:bg-primary-hover">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div
                        ...
                        style="width: 160px; height: 32px; background-size: 32px;"
                      >
                        <div
                          className="star-value"
                          style="background-size: 32px; width: 0px;"
                        ></div>
                      </div>
                      <input
                        name="ratingvalue"
